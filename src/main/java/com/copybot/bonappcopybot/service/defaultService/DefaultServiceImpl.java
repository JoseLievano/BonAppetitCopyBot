...
public abstract class DefaultServiceImpl <DTO, MINIDTO, FORM, ENTITY, ID> implements DefaultService<DTO, MINIDTO, FORM, ID> {

    protected final JpaRepository<ENTITY, ID> repository;
    protected final DefaultMapper<DTO, MINIDTO, FORM, ENTITY> mapper;

    public DefaultServiceImpl(JpaRepository<ENTITY, ID> repository, DefaultMapper<DTO, MINIDTO, FORM, ENTITY> mapper){
